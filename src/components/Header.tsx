...
const Header = () => {
  return (
    <nav className="bg-primary sticky top-0 z-50 w-full flex flex-row items-center h-[9vh] max-h-[9vh]  px-6 py-2 justify-between">
      <a className="cursor-pointer object-cover w-1/4 max-lg:w-1/3" href="/">
        <img src="/images/logo-large.png" alt="logo" className="hover:opacity-80" />
      </a>
      <div className=" text-text_primary text-[14px]">
      ...
      <div className="flex flex-row items-center  text-text_primary font-semibold text-[14px] h-full">
        <a
          className="cursor-pointer hover:bg-shadow px-5   h-full content-center rounded-md"
          href="/"
        >
          Red Loader
        </a>
        ...
        <a
          className="cursor-pointer hover:bg-shadow px-5 h-full content-center rounded-md flex flex-row gap-1 items-center"
        ...
        <div className="dropdown dropdown-end  h-full content-center ">
          <div tabIndex={0} role="button" className="h-full flex items-center ">
            <a className="cursor-pointer hover:bg-shadow px-5 h-full content-center rounded-md flex flex-row gap-1 items-center">
