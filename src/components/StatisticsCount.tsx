...
const StatisticsCount = () => {
  return (
    <div className="bg-[#171212] w-full max-w-[630px] mx-auto flex flex-row gap-2 justify-around max-sm:flex-col max-sm:w-1/2 max-[500px]:w-3/4 ">
      <div className="flex flex-col gap-1 w-1/3 items-center py-2  ">
      ...
      <div className="flex flex-col gap-1  w-1/3 items-center border-l-[1px] border-r-[1px] border-shadow px-10  max-sm:border-0  max-sm:border-b-[1px] max-sm:border-t-[1px] max-sm:px-0  py-2   ">
